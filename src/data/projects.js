...
const data = [
  {
    title: 'Ravenous',
    subtitle: 'A React Web App',
    link: 'https://ayushshrma.github.io/Ravenous/',
    image: '/images/projects/Ravenous.jpg',
    date: '2020-1-20',
    desc:
      ' React Based Web App '
      + 'It is a React web Application that allows users to search the Resturants,'
